...
def intro():
    ...
    "after 4 minutes it rose from $600 to $1001. So you made a lemonade stand as one of your part time jobs. The mafia is hunting you, bribe them with good lemonade to let you live longer. If by the end of 7 days you cant pay off your debt you wont be a very happy camper!"
    )
